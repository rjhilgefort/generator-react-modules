...
module.exports = class Base extends Generator {
  ...
  copyComponent({ templatePath, modulePath, componentName, componentFileName }) {
    // TODO: What's the better pattern then?
    // eslint-disable-next-line no-param-reassign
    if (R.isNil(componentFileName)) componentFileName = componentName;
